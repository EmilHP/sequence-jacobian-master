...
class HetBlock:
    ...
    def ss(self, backward_tol=1E-6, backward_maxit=2000, forward_tol=1E-8, forward_maxit=10_000, **kwargs):
    ...
    def policy_ss(self, ssin, tol=1E-8, maxit=5000):
        ...
        for it in range(maxit):
            ...
            print(f'No convergence of policy functions after {maxit} backward iterations!')
