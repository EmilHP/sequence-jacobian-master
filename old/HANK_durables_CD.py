...
def household(Vd_p, Vb_p, Pi_e_p, b_grid, dg_grid, k_grid, e_grid, sigma_N, sigma_D,
    ...
    theta = 0.807 # share of non-durable consumption in CD utility
    ...
    # c. compute time step 
    Vb,Vd,dg,b,c = time_iteration(sigma,theta,alpha,delta,r,lump,beta,Pi_e_p,dg_grid,z_grid,b_grid,k_grid,zzz,lll,bbb,ddd,
